...
public class SolicitudTrabajoControlador {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity<SolicitudTrabajoResponse> crear(@Valid @ModelAttribute SolicitudTrabajoRequest solicitudTrabajoRequest, BindingResult result) throws MethodArgumentNotValidException {
